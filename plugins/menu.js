 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	{title: `💻 ∫ » Bot Stats`, rowId: ".statserver", description: "✧ Menampilkan Status BOT"},
	{title: `📊 ∫ » Test Speed`, rowId: ".ping", description: "✧ Test Install Speed BOT"},
	{title: `🔧 ∫ » Customer Service`, rowId: ".complaint", description: "✧ Report keluhan mu di sini..."},
	{title: `⚡ ∫ » Speed`, rowId: ".ping", description: "✧ Kecepatan Respon BOT..."},
	]
    },{
	...
	{title: `⫹🍭 › 𐐪-〚 Thanks To 〛-𐑂`, rowId: ".? thnks", description: "╰► Contributor BOT -𐑂"},
